  ...
  const experiences = [
    {
      ...
      company: 'Yes Lorvens Solutions Pvt. Ltd.',
      location: 'Hyderabad, India',
      period: 'June 2025 - Present',
      description: [
        'Designed and developed end-to-end web applications using the MERN stack.',
        'Built scalable backend systems with Node.js, Express.js, MongoDB, and Redis.',
        'Developed responsive frontend interfaces using React and modern UI practices.',
        'Implemented secure authentication using JWT and OAuth 2.0 with RBAC.',
        'Integrated payment workflows including Razorpay and admin verification.',
        'Optimized performance using Redis caching and database query tuning.',
        'Deployed and managed production applications on VPS using Nginx, PM2, and SSL.',
      ],
      logo: '💼',
    },
  ]
